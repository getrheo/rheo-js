...
All four packages share the same semver (`2.5.0.x`) and depend on [`@getrheo/contracts`](https://www.npmjs.com/package/%40getrheo%2Fcontracts) from npm.

**Release:** push git tag `v2.5.0` on `main` → CI publishes all four packages.
